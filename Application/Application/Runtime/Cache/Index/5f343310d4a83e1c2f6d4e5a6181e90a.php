	...
	<nav class="nav">
		...
		<div class="hideBar">
			<ul class="contentLi">
				<li><a href="/index.php/Index/">首页</a></li>
				<li><a href="/index.php/Search/">科协陈列馆</a></li>
				<li id="user" class="willLogin"><a href="javascript:">登录|注册</a></li>
				<?php }else{ ?>
		<div class="hideBar" style="height: 200px">
			<ul class="contentLi">
				<li><a href="/index.php/Index/">首页</a></li>
				<li><a href="/index.php/Search/">科协陈列馆</a></li>
								<li><a href='javascript:;'><?php echo ($_SESSION['userinfo']['username']); ?></a></li>
			...
			<div class="conshelter">
				...
				<div class="loginContent">
					<ul>
						...
						<li><a href="javascript:;" style="position: absolute;right: 40px;margin-top: -10px;text-decoration: none;">忘记密码？</a></li>
						<span class="tip"></span>
		   ...
		   <div class="carousel-inner">
		      ...
		      <div class="item">
		         ...
		         <div class="introduce">
		         	...
		         	<div class="introContent">科宣部，全称科普宣传部。正如其名，我们负责管理校科协的各网络平台，致力于宣传校科协的各项活动。运用Photoshop设计宣传册、海报等展示科技魅力，用网络科普科技知识，将科技与艺术紧密结合，把创新的思想融入到科普宣传中。科宣部的工作需要使用Photoshop等图像制作软件的应用能力以及新闻稿的写作能力（其中PS我们会联合网络部进行授课教学）。</div>
		         </div>
		         <div class="continue">
		         	<a href="javascript:;" class="down">继续向下</a><a href="dddd">报名入口</a>
		         </div>
		      ...
		      <div class="item">
		         ...
		         <div class="introduce">
		         	...
		         	<div class="introContent">外联部，是校科协对外交流的桥梁，主要负责校科协和外界的联系、日常活动的组织与开展以及提供社团经费保障。其中包括校科协与我校九大社团的工作交流，与兄弟院校之间的联系交流，以及与企业之间的沟通。这是一个极具挑战性的部门，同时也是开拓大学生视野的窗口，在这里你可以认识更多本校以及兄弟院校科协的牛人，还可以结识许多企业人士。</div>
		         </div>
		         <div class="continue">
		         	<a href="javascript:;" class="down">继续向下</a><a href="dddd">报名入口</a>
		         </div>
		      ...
		      <div class="item">
		         ...
		         <div class="introduce">
		         	...
		         	<div class="introContent">社团发展部主要负责校科协与各科技类直属社团的联系和交流，建立起两者间的桥梁。发挥科协与直属社团间的不同优势，调度信息资源，促进双方的共同发展。作为创新中心下属部门，社发部还担负着组织参赛的职能，在利用各方资源的同时积极动员同学们参加创新创业方面赛事，同时处理和参与创新中心和科协内的日常工作和活动。</div>
		         </div>
		         <div class="continue">
		         	<a href="javascript:;" class="down">继续向下</a><a href="dddd">报名入口</a>
		         </div>
		...
		<section class="sectionOne">
			<div class="container moreContainer">
				...
				<div class="row row6" align="center">
					...
					<img src="/Public/images/google.jpg" alt="谷歌" class="intro0 ani">
					...
					<img src="/Public/images/huawei.png" alt="华为"class="intro7">
