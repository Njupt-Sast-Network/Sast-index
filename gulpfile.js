...
const SRC              = './src/',
      ...
      DIST_VIEWS       = 'production/Application/Index/View/',
...
gulp.task('build', ['clean'], function () {
    NODE_ENV = 'public';
    gulp.start('build_view', 'uglify', 'css', 'copy_fonts', 'images', 'copy_static_html');
});
